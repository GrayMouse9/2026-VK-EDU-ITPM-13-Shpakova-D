...
| E-mail | **Транзакционный почтовый провайдер** (Яндекс 360) | Дублирующий канал доставки конверта. Свой SMTP не поднимаем — высокая deliverability через готового провайдера. |
